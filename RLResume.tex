...
\section{Experience}
\cventry{Sep 2017 --\newline Present}{Client Network Engineer}{First Strike Games}{
\begin{itemize}
    \item Implementing online services.
\end{itemize}
}
...
\cventry{Jan 2012 --\newline Sep 2013}{Freelance Software Engineer}{}{
    \begin{itemize}
        \item Created server plugins for \textit{Counter-Strike: Source} community game servers including \textit{Multiplayer Bunny Hops: Source} which was used by over 260 concurrent game servers with tens of thousands of players.
    \end{itemize}
}
